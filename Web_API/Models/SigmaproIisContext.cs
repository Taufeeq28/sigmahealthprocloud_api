...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Filter>(entity =>
        {
            ...
            entity.Property(e => e.FilterId).HasColumnName("filter_id").ValueGeneratedOnAdd();
            entity.Property(e => e.PageName).HasColumnName("page_name").HasMaxLength(50);
            entity.Property(e => e.FilterType).HasColumnName("filter_type").HasMaxLength(50);
            entity.Property(e => e.FilterCondition).HasColumnName("filter_condition").HasMaxLength(255);
            entity.Property(e => e.LogicalOperator).HasColumnName("logical_operator").HasMaxLength(5);
        ...
        modelBuilder.Entity<CitiesMasterDoNotUse>(entity =>
        {
            entity
                ...
                .ToTable("cities_master_do_not_use");entity
